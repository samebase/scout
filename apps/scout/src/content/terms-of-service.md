...
You must be at least 18 and legally able to enter into these terms to create an account or
...
Making a chat public allows others to view its messages and associated task activity,
...
Private chat visibility does not prevent a later task from encountering information left in
a shared inbox or external account. Use test data and accounts suitable for this environment.

If you view public content, respect other people's privacy and intellectual-property rights.
Public availability does not authorize harassment, identity theft, or unrestricted reuse.
...
- Harass, impersonate, defraud, threaten, or exploit people, or disclose their private
  information without a lawful basis.
- Send spam, unlawful marketing, fabricated human testimonials, or other deceptive messages.
- Infringe intellectual-property rights or violate applicable law or the rules of a service
  the Scout accesses, including restrictions on automation and gameplay.
- Submit highly sensitive personal information, such as health records, government identity
  documents, financial-account secrets, or children's private information. The current
...
advertising. Data-protection rights continue to apply.

To the extent we have transferable rights in AI output created for you, we assign those
rights to you. Output may not qualify for intellectual-property protection, may resemble
...
## Free access, credits, and purchases

We may provide free access or promotional credits subject to stated limits. Their availability
...
Usage can settle after a task runs and leave a negative credit balance. New work may then be
blocked, and a later purchase first offsets that balance. A negative balance does not
authorize an automatic payment-card charge.

## Refunds and consumer rights

Email contact@samebase.com with the order identifier for billing problems or refund requests.
We coordinate purchase refunds with Polar. Refunded purchases have their corresponding
credits removed. A refund can leave a deficit if those credits have already been used.

You keep all mandatory rights relating to faulty services, non-delivery, cancellation, and
refunds. Where a statutory withdrawal right applies, including the usual 14-day period for
eligible EU distance contracts, you can exercise it without giving a reason. Contact us or
Polar using the order details. Accepting these terms alone does not waive that right.

Any request to begin performance during a withdrawal period, and any acknowledgment needed
to limit that right, must be presented separately where required. Outside mandatory rights,
we assess refund requests individually, including duplicate charges, undelivered credits,
and technical failures. We do not guarantee a refund merely because an AI result was
unsuccessful.

Account deletion is not a refund request. Resolve outstanding purchases or request a refund
before closing your account when possible. Closing an account does not remove rights you
otherwise have to a refund.
...
We may restrict a task or account for a material breach of these terms, security or abuse
concerns, legal requirements, or provider restrictions. Automated checks can block task
requests. You can ask for human review at contact@samebase.com.

Where reasonably possible, we will explain a restriction and allow you to address the
problem. We may act immediately when delay would create harm or violate a legal obligation.

We may change or discontinue features for technical, security, legal, or business reasons.
...
performed on external services.

## Reporting problems and content

Report unlawful content, privacy violations, or suspected infringement to contact@samebase.com.
Include the relevant task URL or content location, an explanation, and enough information
for us to investigate and reply. Do not include unnecessary sensitive information.

We may restrict or remove content that violates these terms or applicable law. When
appropriate, we will explain the action to the affected user and consider a request for
...
Unless mandatory law requires otherwise, these terms are governed by the laws that apply to
the Samebase service operator, subject to mandatory protections that apply where you live.
Courts with jurisdiction under applicable law can hear disputes. These terms do not impose mandatory arbitration, waive collective claims,
or require a consumer to use a court that applicable law does not permit.

You can email contact@samebase.com to seek a resolution. Doing so is not a condition of
exercising rights that the law gives you.
