...
credential shape and temporary migration. The Scout detail page now shows each direct password or
the concrete provider account used for OAuth. The full project check passed with all 259 tests, and
the Convex development push plus local UI verification succeeded
